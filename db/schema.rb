...
ActiveRecord::Schema[8.0].define(version: 2026_09_10_001039) do
  ...
  create_table "tag_bookmarks", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["tag_id"], name: "index_tag_bookmarks_on_tag_id"
    t.index ["user_id", "tag_id"], name: "index_tag_bookmarks_on_user_id_and_tag_id", unique: true
    t.index ["user_id"], name: "index_tag_bookmarks_on_user_id"
  end
  ...
  add_foreign_key "tag_bookmarks", "tags"
  add_foreign_key "tag_bookmarks", "users"
end
